	...
	switch (args[0]) {
		case '1':
			...
			embed = new MessageEmbed()
				...
				.setDescription(
					`${message.lang.changes[0]} ${settings.prefix || message.lang.none} ${message.lang.changes[1]} ${
						args[1]
					}`
				)
		...
		case '2':
			...
			embed = new MessageEmbed()
				...
				.setDescription(
					`${message.lang.changes[0]} ${client.channels.cache.get(settings.wchannel) || message.lang.none} ${
		...
		case '3':
			...
			embed = new MessageEmbed()
				...
				.setDescription(
					`${message.lang.changes[0]}${client.channels.cache.get(settings.gchannel) || message.lang.none} ${
						message.lang.changes[1]
					} ${channel}`
				)
				.setFooter(client.footer)
		...
		case '4':
			...
			embed = new MessageEmbed()
				...
				.setDescription(
					`${message.lang.changes[0]}${settings.wtext || message.lang.none} ${message.lang.changes[1]} ${
						args[1]
					}`
				)
				.setFooter(client.footer)
		...
		case '5':
			...
			embed = new MessageEmbed()
				...
				.setDescription(
					`${message.lang.changes[0]} ${settings.gtext || message.lang.none} ${message.lang.changes[1]} ${
						args[1]
					}`
				)
				.setFooter(client.footer)
		...
		case '7':
			...
			embed = new MessageEmbed()
				...
				.setDescription(
					`${message.lang.changes[0]} ${settings.genabled ? message.lang.enabled : message.lang.disabled} ${
						message.lang.changes[1]
		...
		default:
			embed = new MessageEmbed()
				...
				.addField(message.lang.defaultt.we, settings.wenabled ? message.lang.enabled : message.lang.disabled)
				.addField(message.lang.defaultt.ge, settings.genabled ? message.lang.enabled : message.lang.disabled)
